...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:serverpod_hackathon_server/src/generated/menu_item.dart' as _i5;
import 'package:serverpod_hackathon_server/src/generated/greeting.dart' as _i6;
import 'package:serverpod_hackathon_server/src/generated/protocol.dart';
import 'package:serverpod_hackathon_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _MenuSeedEndpoint menuSeed;
...
class _MenuEndpoint {
  ...
  _i3.Future<bool> createMenuItem(
    _i1.TestSessionBuilder sessionBuilder,
    _i5.MenuItem item,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<List<_i5.MenuItem>> getAllMenuItems(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
...
class _MenuSeedEndpoint {
  ...
  _i3.Future<int> seedMenuData(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'menuSeed',
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'menuSeed',
          methodName: 'seedMenuData',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _RagEndpoint {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          endpointPath: 'rag',
          methodName: 'chat',
          parameters: _i1.testObjectToJson({'userMessage': userMessage}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<void> generateMenuEmbedding(
    _i1.TestSessionBuilder sessionBuilder,
    int menuItemId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'rag',
            method: 'generateMenuEmbedding',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'rag',
          methodName: 'generateMenuEmbedding',
          parameters: _i1.testObjectToJson({'menuItemId': menuItemId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<int> generateAllEmbeddings(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'rag',
            method: 'generateAllEmbeddings',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'rag',
          methodName: 'generateAllEmbeddings',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
